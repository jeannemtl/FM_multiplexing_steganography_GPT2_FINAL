...
class FrequencyiMECHybridEncoder:
    ...
    def __init__(self, model_name='gpt2'):
        ...
        print(f"Using 12-bit iMEC blocks")
    ...
    def apply_imec_obfuscation(self, freq_tokens, context):
        ...
        """
        print("\n" + "="*80)
        print("STAGE 2: iMEC OBFUSCATION (with encryption, 12-bit blocks)")
        print("="*80)
        ...
        # Apply iMEC encoding to UNIFORM ciphertext with 12-bit blocks
        print(f"\n✓ Applying iMEC with 12-bit blocks...")
        print(f"  Block size: 12 bits (4,096 possible values per block)")
        ...
        # Store metadata INCLUDING encryption key and 12-bit block size
        metadata = {
    ...
    def encode_hybrid(self, context, messages, sequence_length=300):
        ...
        """
        print("\n" + "="*80)
        print("HYBRID ENCODER: FREQUENCY + iMEC (12-bit blocks)")
        print("="*80)
        ...
        with open('hybrid_freq_imec_data_12bit.pkl', 'wb') as f:
        ...
        print(f"✓ Saved to: hybrid_freq_imec_data_12bit.pkl")
